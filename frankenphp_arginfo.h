 ...
 * Stub hash: 10bd57bec61bfee45ece6e12017a8c44bc1db83f */
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_frankenphp_request_parse_errors, 0, 0, IS_ARRAY, 0)
ZEND_END_ARG_INFO()

#define arginfo_frankenphp_request_headers arginfo_frankenphp_request_parse_errors

#define arginfo_apache_request_headers arginfo_frankenphp_request_parse_errors

#define arginfo_getallheaders arginfo_frankenphp_request_parse_errors
...
ZEND_FUNCTION(frankenphp_request_parse_errors);
...
static const zend_function_entry ext_functions[] = {
	...
	ZEND_FE(frankenphp_request_parse_errors, arginfo_frankenphp_request_parse_errors)
