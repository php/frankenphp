...
The following article summarizes this issue and explains how to fix it, notably for Symfony applications using ResetInterface to ensure your stateful services are "clean" for every new request.
