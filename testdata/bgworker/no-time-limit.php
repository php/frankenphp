...
// short, and it parks in a blocking read without a stream timeout, so
// default_socket_timeout must not end the read either. Counts its runs in
// BG_COUNT_FILE, so anything that interrupts the park shows up as a second
// line.
